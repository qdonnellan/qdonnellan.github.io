...
- **Algorithms 1**, Princeton University [via Coursera][3]
- **Algorithms 2**, Princeton University [via Coursera][4]
- **Learn C the Hard Way**, [learncodethehardway.org][5]
- **Introduction to Operating Systems**, Georgia Tech [via Udacity][6]
- **Intro to Parallel Programming**, [Udacity][7]
- **Artificial Intelligence for Robotics**, Georgia Tech [via Udacity][8]
- **Intro to Machine Learning**, [Udacity][9]
...
[6]: https://www.udacity.com/course/introduction-to-operating-systems--ud923
[7]: https://www.udacity.com/course/intro-to-parallel-programming--cs344
