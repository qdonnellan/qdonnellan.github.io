...
categories: blog
ogimage: /images/zero-to-cto-og-image.png
tags:
    - featured
    - omscs
---
...
There was a four &mdash; or five &mdash; month stretch where I pitched a new career objective to my wife on a *daily basis*; thanks for putting up with all *those* conversations Kristen! And then I landed on a resolution:
...
What follows is my attempt to answer that question. Of course I'm no "CTO" myself, I'm just the resident *idiot* around here. But over the last 6 months I've talked to CEO's, CTO's, product managers, VP's; I've read hundreds of job postings for top-level type jobs; I've read the personal profiles of hundreds of people in the industry; I've read countless articles &mdash; good and bad &mdash; on the subject. I'm confident that if this plan doesn't work, it'll get me darn close, and unlike some of the bad blog posts I've read &mdash; which seem to do nothing more than suggest you need to suck up to the right people &mdash; this advice is concrete and actionable.
...
Knowing how your software applications work is only a small slice of the things you should know as a CTO. Understanding the *business of software* and business principles at large is at least as important &mdash; if not much more important &mdash; than just being a technical whiz.
...
If you *really* want to get hands-on business experience, then I highly recommend working for (or founding your own) software startup. If you are young &mdash; without many dependents &mdash; and can afford the risk of running in the software fast lane, you will learn more about the end-to-end business of software than doing just about anything else.
...
If you have any thoughts, comments, or personal experiences from your own journey, please let me know! I can always be reached at [quentin@qdonnellan.com][1].

To all those currently working toward a similar goal, or just beginning: Good luck!

[1]: mailto:quentin@qdonnellan.com
