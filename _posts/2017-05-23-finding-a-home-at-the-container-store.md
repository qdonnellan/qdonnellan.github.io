---
layout: post
title:  "Finding a Home on the Software Team at The Container Store"
...
That is exactly where my wife and I were this January when I got a call from Bobby Grohmann, a friend and an incredible recruiter at [Improving][1]. Bobby asked if I had ever thought about working for *The Container Store*. "You mean that place that sells shoe boxes and closet... things?". Yes. That place.
...
You see, The Container Store is not just *some retailer*, we are one of the [best places to work for][2] in the country. And our software team isn't just building some eCommerce website (we are also doing that) - but we've got our hands on some really amazing stuff. Let's just say that if you've recently completed any of [Udacity's nanodegrees][3] you'd find something to work on here (OK, we're not building a self-driving car, but the rest of that list is fair game).
...
Of course, if you happen to be in the Dallas/Fort-Worth area I cannot recommend The Container Store enough; **we are always looking for talented engineers** to join our staff; please email me if you have any questions or want to learn more about what we're building: <a href="mailto:{{site.email}}">{{ site.email }}</a>


[1]: http://improving.com/
[2]: http://standfor.containerstore.com/18-awesome-years-on-fortunes-100-best-list
[3]: https://www.udacity.com/nanodegree