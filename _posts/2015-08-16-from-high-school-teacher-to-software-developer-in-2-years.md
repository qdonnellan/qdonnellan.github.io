...
At any rate, I did know *some* software in 2012. I could type, understood what a terminal was, and had a background in solving problems. Like any good nerd at the time I also had some high school experience hacking together some HTML/CSS (mostly things that looked horrible). Such was my skill set at the time. 
...
3. September 2012 - built a homecoming voting application for the Senior Class at my high school
...
11. February 2014 - my very first tech interview: a rather epic failure with Fog Creek
...
In the end, I had secured a job as a web developer after initially pursuing the thing as a hobby - as something to help me be a more efficient teacher. I don't think I really knew that I would leave teaching when I started that Udacity Course in 2012.
...
### Meet People
In the beginning my sole focus was to build code in the den of my office. Toward the end of my journey I eventually started meeting actual human beings. I wish I had done this earlier in the process. In the end jobs are given by people to people, not by robots scanning your StackOverflow accounts!
